            ...
            <div class="owl-carousel owl-theme owl-achivement">
                ...
                <div class="col">
                    <div class="achivements__details">
                        <div class="achivements__details__list__box">
                            <div class="logo-img">
                                <img src="{{ asset('user/images/about/trustpilot-logo.png') }}" alt="img"
                                    class="img">
                            </div>
                        </div>
                    </div>
                ...
                <div class="col">
                    <div class="achivements__details">
                        ...
                        <div class="achivements__details__list__box">
                            <div class="logo-img">
                                <img src="{{ asset('user/images/about/trip-advisor (1).png') }}" alt="img"
                                    class="img">
                            </div>
                ...
                <div class="owl-carousel owl-theme owl-destination ">
                    <a ">
                        <div class="destination__details__list">
                            <div class="destination__details__list__box">
                                <div class="logo-img">
                                    <img class="owl-lazy" data-src="{{ asset('user/images/pokhara.webp') }}"
                                        data-src-retina="{{ asset('user/images/pokhara.webp') }}" alt="img">
                                </div>
                                <div class="text">
                                    <div>
                                        <h5>Pokhara </h5>
                    ...
                    <a href="">
                        <div class="destination__details__list">
                            <div class="destination__details__list__box">
                                <div class="logo-img">
                                    <img class="owl-lazy" data-src="{{ asset('') }}images/pokhara.webp"
                                        data-src-retina="{{ asset('user/images/pokhara.webp') }}" alt="img">
                                </div>
                    ...
                    <a href="">
                        <div class="destination__details__list">
                            <div class="destination__details__list__box">
                                <div class="logo-img">
                                    <img class="owl-lazy" data-src="{{ asset('user/images/dhangadhi.jpg') }}"
                                        data-src-retina="{{ asset('user/images/dhangadhi.jpg') }}" alt="img">
                                </div>
