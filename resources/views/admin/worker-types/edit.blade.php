                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control rounded" type="text" id="types" value="@if(isset($data['rows']->types)) {{ $data['rows']->types }} @else {{ old('types') }} @endif" name="types" placeholder="कामदार प्रकार">
                                @if($errors->has('types'))
