...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h4  text-primary">Add Interview Types</h1>
</div>
        ...
        <form action="{{ route($_base_route.'.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="ibox">
                        <div class="ibox-head">
                            <div class="ibox-title">Add Interview Types</div>
                        ...
                        <div class="ibox-body">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="title" id="title" value="{{ old('url') }}" placeholder="Interview Types">
                                @if($errors->has('title'))
