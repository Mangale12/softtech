        ...
        <form action="{{ route($_base_route.'.update', $data['category']->id )}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="ibox">
                        <div class="ibox-head">
                            <div class="ibox-title">Edit Interview Types</div>
                        ...
                        <div class="ibox-body">
                            <div class="form-group">
                                <label for="title">Interview Types Name</label>
                                <input class="form-control" type="text" name="title" id="title" value="@if(isset($data['category']->title)) {{ $data['category']->title   }} @endif" placeholder="Interview Types">
                                @if($errors->has('title'))
