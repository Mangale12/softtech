...
<div class="container">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div class="row">
            ...
            <a href="{{route( 'admin.agriculture.index')}}" class="d-none d-sm-inline-block btn btn-sm btn-info shadow-sm"><i class="fa fa-gear"></i> बालीनाली सेटअप</a>
        </div>
    </div>
</div>
<div class="row">
