            ...
            <section class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="date" value="{{getStandardNumber( $data['nep_date_unicode'])}}" name="order_date" placeholder="YYYY/MM/DD" class="form-control round" readonly/>
                    </div>
                    <div class="row">
                            ...
                            <tbody>
                                <tr>
                                    <td style="width:20rem">
                                        <select name="seed_id[]" class="form-control">
                                    ...
                                    <td style="width:20rem">
                                        <input type="number" name="quantity[]" class="form-control stock-quantity" placeholder="स्टक मात्रा" />
