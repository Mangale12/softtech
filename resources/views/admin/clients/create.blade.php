                        ...
                        <div class="ibox-body">
                            <div class="row">
                                <div class="col-sm-4 col-md-4 form-group">
                                    ...
                                    <select name="clients_types" class="form-control category_id select_category" id="category_id">
                                        ...
                                        <option value="placement_partner">Placement Partners</option>
                                        <option value="international_association">International Association</option>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <textarea name="description" id="my-editor" placeholder="Remarks" cols="30" rows="5" class="form-control rounded" value="">{{ old('description') }}</textarea>
                                </div>
                            </div>
