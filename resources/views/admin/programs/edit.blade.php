                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control rounded" type="text" id="title" value="{{ old('title', $data['row']->name) }}" name="title" placeholder="कार्यक्रम शीर्षक">
                                @if($errors->has('title'))
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control rounded" type="text" id="start_date" readonly value="{{ old('start_date',  $data['row']->start_date) }}" name="start_date" placeholder="कार्यक्रम मिति">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control rounded" type="text" id="end_date" readonly value="{{ old('end_date', $data['row']->end_date) }}" name="end_date" placeholder="end_date">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control rounded" type="text" id="mobile" value="{{ old('location', $data['row']->location) }}" name="location" placeholder="location">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control rounded" type="text" id="price" value="{{ old('price', $data['row']->price) }}" name="price" placeholder="खर्च">
                                @if($errors->has('price'))
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea name="sponsor_details" id="sponsor_details" class="form-control rounded description" rows="6">{!! $data['row']->sponsor_details !!}</textarea>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea name="organizer_details" id="organizer_details" class="form-control rounded description" rows="6">{!! $data['row']->organizer_details !!}</textarea>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea name="coordination_organization" id="coordination_organization" class="form-control rounded description" rows="6">{!! $data['row']->coordination_organization !!}</textarea>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea name="participation_details" id="participation_details" class="form-control rounded description" rows="6">{!! $data['row']->participation_details !!}</textarea>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea name="description" id="description" class="form-control rounded description" rows="6">{!! $data['row']->description !!}</textarea>
