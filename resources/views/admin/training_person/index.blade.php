...
@section('title', 'प्रशिक्षण व्यक्ति')
@section('css')
...
<div class="container">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div class="row">
            {{-- <a href="{{route( $_base_route.'.create' )}}{{ !empty($data['udhyog']) ? ($data['udhyog'] != null ? '?udhyog=' $data['udhyog']['name'] : '') : '' }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fa fa-plus fa-sm text-white-50"></i> नयाँ बनाउनुहोस्</a>&nbsp; --}}
            <a href="{{ route($_base_route.'.create') }}{{ !empty($data['udhyog']) ? ($data['udhyog'] != null ? '?udhyog='.$data['udhyog']['name'] : '') : '' }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fa fa-plus fa-sm text-white-50"></i> नयाँ बनाउनुहोस्</a>&nbsp;
