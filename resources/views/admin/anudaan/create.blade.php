                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control rounded" type="text" id="title" value="{{ old('title') }}" name="title" placeholder="शीर्षक">
                                @if($errors->has('title'))
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control rounded" type="text" id="amount" value="{{ old('amount') }}" name="amount" placeholder="रु.">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control rounded" type="text" id="bibran" value="{{ old('bibran') }}" name="bibran" placeholder="बिबरण">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control rounded" type="text" id="times" value="{{ old('times') }}" name="times" placeholder="पटक">
                                @if($errors->has('times'))
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control rounded" type="text" id="daatrinikay_sahayog	" value="{{ old('daatrinikay_sahayog') }}" name="daatrinikay_sahayog" placeholder="दात्रिनिकाय सहयोग">
                        ...
                        <!-- <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control rounded" type="text" id="criteria" value="{{ old('criteria') }}" name="criteria" placeholder="मापदण्ड">
