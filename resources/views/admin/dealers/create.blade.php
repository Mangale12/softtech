                        ...
                        <table class="table table-bordered" id="dynamicTable">
                            ...
                            <tr>
                                ...
                                <td style="width:10rem">
                                    <div class="form-group">
                                        <label class="ui-checkbox">
                                            ...
                                            <input style="scale: 1.6;" type="checkbox" name="is_dealer" value="1" id="status-checkbox" checked><span class="input-span"></span>
                                        </label>
                                    </div>
                                </td>
                                </tr>
                                ...
                                <table class="table table-bordered" id="dealer-table">
                                    ...
                                    <tr>
                                        <td style="width:30rem">
                                            <input type="text" value="{{ old('contactor_name') }}" name="contactor_name" placeholder="पुरा नाम" class="form-control" />
                                        ...
                                        <td style="width:20rem">
                                            <input type="text" value="{{ old('contactor_phone') }}" name="contactor_phone" placeholder="फोन" class="form-control" />
                                            @if($errors->has('phone'))
