...
<div class="row">
    <div class="col-lg-12 col-12">
        {{-- {{ dd($_base_route) }} --}}
        <form action="{{ route('admin.inventory.sales_orders.store')}}" method="POST" enctype="multipart/form-data">
            <section class="card">
                            ...
                            <tr>
                                <td style="width:20rem">
                                    <select name="dealer_id" id="" class="form-control order-type">
                                        ...
                                        <option value="1" {{ isset($data['dealer']) && $data['dealer']->is_dealer == 1 ? 'selected' : '' }}>डिलर</option>
                                        <option value="2" {{ isset($data['dealer']) && $data['dealer']->is_dealer == 0 ? 'selected' : '' }}>व्यक्तिगत</option>
                                    </select>
                                ...
                                <td style="width:20rem">
                                    <input class="form-control rounded " value="{{ $data['dealer']->name }}" type="text" id="dealer_id" readonly>
                                    <input value="{{ $data['dealer']->id }}" type="hidden" name="dealer_id" readonly>
