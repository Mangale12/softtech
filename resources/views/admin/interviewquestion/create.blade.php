                    ...
                    <div class="ibox">
                        ...
                        <div class="ibox-body">
                            ...
                            <div class="form-group row">
                                ...
                                <input class="form-control rounded col-md-10" type="text" name="title" id="title" value="{{ old('title') }}" placeholder="Question Name">
                            </div>
                            <div class="form-group row">
                                <label for="title" class="col-md-2">Question Answer(<em style="color:red">*</em>)</label>
                                <textarea name="description" cols="5" rows="3" class="form-control rounded col-md-10" placeholder="Question Answer" value="">{{ old('description') }}</textarea>
                            </div>
                            <div class="form-group row">
