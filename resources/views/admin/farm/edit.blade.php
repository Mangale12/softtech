                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="title">अनुदान प्रकार</label> <br>
                                <input class="form-control rounded" type="text" id="title" value="@if(isset($data['rows']->title)) {{ $data['rows']->title }} @else {{ old('title') }} @endif" name="title" placeholder="अनुदान प्रकार">
                                @if($errors->has('title'))
