                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control rounded" type="text" id="title" value="{{ old('name', $data['rows']->name) }}" name="name" placeholder="बिउ प्रकार नाम">
                                @if($errors->has('name'))
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <textarea name="description" id="description" class="form-control">{{ $data['rows']->description }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
