     ...
     <div id="sidebar-collapse">
         ...
         <ul class="side-menu metismenu">
             <li class="{{ ($_panel == 'Dashboard') ? 'active' : '' }}">
                 <a class="{{ ($_panel == 'Dashboard') ? 'active' : '' }}" href="{{ route('admin.index') }}"><i class="sidebar-item-icon fa fa-th-large"></i>
                     <span class="nav-label">Dasboard</span>
                 </a>
             </li>

             <li class="heading">FEATURES</li>
             <!-- <li class="{{ ($_panel == 'Banner' || $_panel == 'Service' || $_panel == 'Carrers' || $_panel == 'Achievement' ) ? 'active' : '' }}">
             ...
             <li class="{{ ($_panel == 'Service' || $_panel == 'Banner' || $_panel == 'Testimonial' || $_panel == 'Achievement' ||  $_panel == 'Faq' || $_panel == 'QuizPractice'|| $_panel == 'Gallery' || $_panel == 'Video' ) ? 'active' : '' }}">
                 ...
                 <ul class="nav-2-level collapse">
                     ...
                     <li>
                         <a class="{{ ($_panel == 'Banner') ? 'active' : '' }}" href="{{ route('admin.banner.index')}}"><i class="sidebar-item-icon fa fa-sliders"></i>Banner</a>
                     </li>
                     <li>
                         <a class="{{ ($_panel == 'Service') ? 'active' : '' }}" href="{{ route('admin.our_service.index') }}"><i class="sidebar-item-icon fa fa-slideshare"></i>Our Services </a>
                     </li>
                     <li>
                     ...
                     <li>
                         <a class="{{ ($_panel == 'Gallery') ? 'active' : '' }}" href="{{ route('admin.gallery.index')}}"><i class="sidebar-item-icon fa fa-picture-o"></i>Photo Gallery</a>
                     </li>
                     <li>
                         <a class="{{ ($_panel == 'Video') ? 'active' : '' }}" href="{{ route('admin.video.index')}}"><i class="sidebar-item-icon fa fa-video-camera"></i>Videos</a>
                     </li>
                 </ul>
             </li>
             <li class="{{ ($_panel == 'Destination'|| $_panel == 'Transport' || $_panel == 'Hashtag' || $_panel == 'Experience' || $_panel == 'Cultural' || $_panel == 'Difficult' || $_panel == 'Season' || $_panel == 'Category' || $_panel == 'Blog' || $_panel == 'Section' || $_panel == 'Posts' || $_panel == 'Pages' ||  $_panel == 'Demand' ||  $_panel == 'Programs' ||  $_panel == 'Counter') ? 'active' : '' }}">
                 ...
                 <ul class="nav-2-level collapse">
                     <li>
                         <a class="{{ ($_panel == 'Category') ? 'active' : '' }}" href="{{ route('admin.blogcategory.index')}}"><i class="sidebar-item-icon fa fa-tasks"></i> Category</a>
                     </li>
                     <li>
                         <a class="{{ ($_panel == 'Season') ? 'active' : '' }}" href="{{ route('admin.season.index')}}"><i class="sidebar-item-icon fa fa-heart"></i> Season</a>
                     </li>
                     <li>
                         <a class="{{ ($_panel == 'Difficult') ? 'active' : '' }}" href="{{ route('admin.difficult.index')}}"><i class="sidebar-item-icon fa fa-deaf"></i> Difficult</a>
                     </li>
                     <li>
                         <a class="{{ ($_panel == 'Experience') ? 'active' : '' }}" href="{{ route('admin.experience.index')}}"><i class="sidebar-item-icon fa fa-arrows-alt"></i> Experience</a>
                     </li>
                     <li>
                         <a class="{{ ($_panel == 'Cultural') ? 'active' : '' }}" href="{{ route('admin.cultural.index')}}"><i class="sidebar-item-icon fa fa-user"></i> Cultural</a>
                     </li>
                     <li>
                         <a class="{{ ($_panel == 'Transport') ? 'active' : '' }}" href="{{ route('admin.transport.index')}}"><i class="sidebar-item-icon fa fa-car"></i> Transport</a>
                     </li>

                     <li>
                         <a class="{{ ($_panel == 'Destination') ? 'active' : '' }}" href="{{ route('admin.destination.index')}}"><i class="sidebar-item-icon fa fa-map-marker"></i> Destination</a>
                     </li>
                     <li>
             ...
             <li class="{{ ($_panel == 'Member Type') ? 'active' : '' }}">
                 <a href=" javascript:;"><i class="sidebar-item-icon fa fa-users"></i>
                     <span class="nav-label">User Management</span><i class="fa fa-angle-left arrow"></i></a>
                 <ul class="nav-2-level collapse">
                     <li>
                         <a class="{{ ($_panel == 'Member Type') ? 'active' : '' }}" href="{{ route('admin.member_type.index')}}"><i class="sidebar-item-icon fa fa-user-circle-o"></i> Member Type</a>
                     </li>
                     <li>
                         <a class="" href="{{ route('admin.users.index')}}"><i class="sidebar-item-icon fa fa-users"></i>Member List</a>
                     </li>
                     <li>
                         <a class="" href="{{ route('admin.users.index')}}"><i class="sidebar-item-icon fa fa-users"></i>Admin List</a>
                     </li>
                 </ul>
             </li>
