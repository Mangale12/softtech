                        ...
                        <div class="ibox-body">
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    ...
                                    <input class=" form-control" type="file" id="thumbs" name="thumbs" value="" accept="image/webp, image/*">
                                </div>
                                <div class="form-group col-sm-4 col-md-2">
                                    @if(isset($data['rows']->thumbs) && !empty($data['rows']->thumbs))
                                    <img src="{{ $data['rows']->thumbs }}" alt="" width="50px;">
                                    @else
                                ...
                                <div class="form-group col-sm-4 col-md-2">
                                    ...
                                    <img src="{{ $data['rows']->route_map }}" alt="" width="50px;">
                                    @else
                                    <p>Map Not Found's !</p>
                                    @endif
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" cols="30" rows="9" id="my-editor" class="form-control rounded my-editor">{!! old('description', $data['rows']->description) !!}</textarea>
                            </div>
                            <div class="form-group">
                                <label>More Info</label>
                                <textarea name="more_details" cols="30" rows="4" class="form-control rounded summernote">{{ old('description', $data['rows']->more_details) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-8">
                    ...
                    <div class="ibox">
                        ...
                        <div class="ibox-body">
                            ...
                            <div class="panel-body">
                                @php
                                $faqs = json_decode($data['rows']->faqs, true);
                                @endphp
                    ...
                    <div class="ibox">
                        ...
                        <div class="ibox-body">
                            ...
                            <div class="panel-body">
                                @php
                                $videos = json_decode($data['rows']->videos, true);
                                @endphp
                                ...
                                <div class="form-group video">
                                    ...
                                    <div class="input-group control-group increment-days row mt-1" style="margin-left:0">
                                        ...
                                        <img src="{{ !empty($video['thumbnail']) ? asset($video['thumbnail']) : '' }}" alt="blog video thumnail" height="30" width="30">
                                    </div>
                                </div>
                                @endforeach
                                @else
                    ...
                    <div class="ibox-body">
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 mb-2 img-box">

                                    <a href="{{ asset($image->image_path) }}">
                                        <img src="{{ asset($image->image_path) }}" alt="Blog Image" class="card-img-top img-thumbnail" width="40px" height="40px">
                                    </a>
