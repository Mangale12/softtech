                    ...
                    <div class="ibox">
                        ...
                        <div class="ibox-body">
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-12 form-group">
                                    <label>Title</label>
                                    <input class="form-control rounded" type="text" name="title" id="title" value="@if(isset($data['rows']->title)) {{ $data['rows']->title   }} @endif" placeholder="Title">
                                </div>
                            </div>
                            <div class="form-group">
                                <label>Description</label>
                                <textarea name="description" cols="30" rows="9" class="form-control rounded summernote">@if(isset($data['rows']->description)) {{ $data['rows']->description   }} @endif</textarea>
                            </div>
                        </div>
                    </div>
                </div>
