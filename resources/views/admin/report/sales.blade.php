...
<div style="container-fluid">
    <form class="form-inline" action="{{ route($_base_route.'.sales')}}" method="GET">
        <div class="row mr-1">
            ...
            <div class="mb-3 col-3">
                ...
                <a class="btn btn-primary btn-sm " href="{{ route($_base_route.'.sales')}}">सफा गर्नुहोस्</a>
            </div>
                    ...
                    <table class="display table table-bordered table-striped" id="dynamic-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->dealer_id != null ? $item->dealer->name : '' }}</td>
