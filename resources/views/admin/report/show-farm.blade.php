...
@section('title', 'खेत बारी रिपोर्ट')
@section('css')
<style>
    p {
        font-size: 15px;
...
<div class="container">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div class="text-center invoice-btn">
            <a href="{{route( 'admin.report.farm_index')}}" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm"><i class="fa fa-long-arrow-left"></i> पछाडी फर्किनुहोस्</a>&nbsp;
    ...
    <div class="card card-primary">
        ...
        <div class="card-body">
            <div class="row invoice-list">
                ...
                <div class="col-lg-3 col-sm-3">
                    <h4 style="font-weight: bold;">किसान छान्नुस</h4>
                    <p>@if(isset($data['rows']->generalProfile)) {{ $data['rows']->generalProfile->full_name }} @endif</p>
                </div>
                <div class="col-lg-3 col-sm-3">
                    <h4 style="font-weight: bold;">जग्गा छान्नुस</h4>
                    <p>@if(isset($data['rows']->getLand)) {{ $data['rows']->getLand->totalbigaha }} @endif</p>
                </div>
                <div class="col-lg-3 col-sm-3">
                    <h4 style="font-weight: bold;">बाली प्रकार</h4>
                    <p>@if(isset($data['rows']->agricultureCat)) {{ $data['rows']->agricultureCat->title }} @endif</p>
                </div>
                <div class="col-lg-3 col-sm-3">
            ...
            <div class="row invoice-list">
                ...
                <div class="table-responsive" tabindex="1" style="overflow: hidden; outline: none;">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <?php $featuredArray = json_decode($data['rows']->schedule_detail); ?>
                            @if($featuredArray)
                            @foreach($featuredArray as $key=> $resource)
                            <tr>
                                <th scope="row">{{ getUnicodeNumber($key+1) }}.</th>
