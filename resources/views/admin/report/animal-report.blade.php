...
<div class="container">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div class="row">
            <h3>पशुपन्छी बिबरण</h3>
        </div>
    </div>
</div>
<div style="justify-content: center">
    <form class="form-inline" action="{{ route($_base_route.'.animal_search')}}" method="GET">
        @csrf
        <select name="animal_id " id="animal_id " class="form-control select-two col-md-2">
        ...
        <input class="form-control mr-sm-2" type="search" name="title" placeholder="पशुपन्छी" aria-label="Search">
        <button class="btn btn-sm btn-info my-2 my-sm-0" type="submit">रिपोट खोज्नुस्</button>&nbsp;
        <a class="btn btn-primary btn-sm pull-right" href="{{ route($_base_route.'.animal_index')}}">सफा गर्नुहोस्</a>
    </form><br>
