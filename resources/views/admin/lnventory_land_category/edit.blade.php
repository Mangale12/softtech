                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="fiscal_np">जमिन किसिम</label> <br>
                                <input class="form-control rounded" type="text" id="title" value="@if(isset($data['rows']->title)) {{ $data['rows']->title }} @else {{ old('title') }} @endif" name="title" placeholder="जमिन किसिम">
                                @if($errors->has('title'))
