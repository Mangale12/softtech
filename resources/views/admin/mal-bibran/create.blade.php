    ...
    <div class="col-lg-8">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">मल बिबरण </a></li>
            </ol>
        </nav>
        <!--breadcrumbs end -->
    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control rounded" type="text" id="title" value="{{ old('title') }}" name="title" placeholder="मल नाम">
                                @if($errors->has('title'))
                        ...
                        <!-- <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" name="optional" id="optional" class="checked a">
                                    </label>
                                </div>
                            </div>
                        </div>
