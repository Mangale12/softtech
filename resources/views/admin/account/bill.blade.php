            ...
            <form action="{{ route('admin.billing.store')}}" method="POST" enctype="multipart/form-data">
                ...
                <table class="table table-bordered" id="item-table">
                    ...
                    <tbody>
                        ...
                        @endforeach
                        <tr>
                            <td colspan="5" align="right" class="font-weight-bold">उप कुल रकम</td>
                            <td class="font-weight-bold sub-total">{{ $data['row']->rawMaterials->sum('total_cost') }}</td>
                        </tr>
                        <tr>
                            <td colspan="5" align="right" class="font-weight-bold">छुट रकम</td>
                            <td class="font-weight-bold" style="width: 10rem"><input class="form-control discount-amount" type="text" value="0" name="discount"  ></td>
                        </tr>
                        <tr>
                            <td colspan="5" align="right" class="font-weight-bold">कर योग्य रकम</td>
                        ...
                        <tr>
                            <td colspan="5" align="right" class="font-weight-bold">कूल जम्मा रकम</td>
