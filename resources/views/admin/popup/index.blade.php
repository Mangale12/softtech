                    ...
                    <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ URL::route($_base_route.'.edit', ['id' => $row->id]) }}"><button type="button" data-original-title="Edit" data-toggle="tooltip" class="btn btn-warning btn-sm" style="cursor:pointer;"><i class="fa fa-pencil"></i>&nbsp;Edit</button></a>
