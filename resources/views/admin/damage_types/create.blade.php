        ...
        <form action="{{ route($_base_route.'.store')}}" method="POST" enctype="multipart/form-data">
            <section class="card">
                <header class="card-header">
                   {{ !empty($udhyog) ? $udhyog->name : '' }} क्षतिको प्रकार
                </header>
                <div class="card-body">
                    @csrf
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="type">क्षतिको प्रकार</label> <br>
                                <input class="form-control rounded" type="text" id="type" value="{{ old('type') }}" name="type" placeholder="क्षतिको प्रकार">
                                @if($errors->has('type'))
