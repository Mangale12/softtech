    ...
    <div class="col-lg-8">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">नयाँ पशुपन्छी </a></li>
            </ol>
        </nav>
        <!--breadcrumbs end -->
    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="animal_id">पशुपन्छी प्रकार </label> <br>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="title">नयाँ पशुपन्छी </label> <br>
                                <input class="form-control rounded" type="text" id="title" value="{{ old('title') }}" name="title" placeholder="नयाँ पशुपन्छी">
                                @if($errors->has('title'))
