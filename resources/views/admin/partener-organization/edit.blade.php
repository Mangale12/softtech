...
@section('title', 'साझेदार संस्थाहरु')
@section('css')
<!--Form Wizard-->
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control rounded" type="text" id="name" value="{{ old('name', $data['row']->name) }}" name="name" placeholder="संस्थाकाे नाम">
                                @if($errors->has('name'))
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control rounded" type="text" id="address"  value="{{ old('address', $data['row']->address) }}" name="address" placeholder="संस्थाको ठेगाना">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control rounded" type="email" id="email" value="{{ old('email', $data['row']->email) }}" name="email" placeholder="संस्थाको इमेल">
                                @if($errors->has('email'))
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control rounded" type="text" id="phone" value="{{ old('phone', $data['row']->phone) }}" name="phone" placeholder="संगठनको फोन">
                                @if($errors->has('phone'))
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea name="description" id="description" class="form-control rounded" rows="6">{!! $data['row']->description !!}</textarea>
