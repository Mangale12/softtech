                    ...
                    <div class="row">
                        <table class="table table-bordered" id="dynamicTable">
                            ...
                            <tr>
                                ...
                                <td style="width:20rem">
                                    <input class="form-control rounded " type="text" id="date" value="{{getStandardNumber( $data['nep_date_unicode'])}}" name="start_date" placeholder="सिजन सुरु मिति" readonly>
                                ...
                                <td style="width:20rem">
                                    <input class="form-control rounded " type="text" id="end-date" value="{{getStandardNumber( $data['nep_date_unicode'])}}" name="end_date" placeholder="सिजन समाप्त मिति" readonly>
