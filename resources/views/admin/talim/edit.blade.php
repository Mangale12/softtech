                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control rounded" type="text" id="title" value="@if(isset($data['rows']->title)) {{ $data['rows']->title }} @else {{ old('title') }} @endif" name="title" placeholder="तालिम शीर्षक">
                                @if($errors->has('title'))
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control rounded" type="text" id="duration" value="@if(isset($data['rows']->duration)) {{ $data['rows']->duration }} @else {{ old('duration') }} @endif" name="duration" placeholder="तालिम अबधि">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control rounded" type="text" id="total_cost" value="@if(isset($data['rows']->total_cost)) {{ $data['rows']->total_cost }} @else {{ old('total_cost') }} @endif" name="total_cost" placeholder="तालिम शुल्क">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="description" cols="5" rows="3" id="description" class="form-control rounded summernote" value="">{!! $data['rows']->description !!}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <tbody>
                               ...
                               @foreach($featuredArray as $resource)
                                ...
                                <tr class="soft-multyfield">
                                    ...
                                    <td class="col-md-2 form-group ">
                                        <input type="text" class="form-control rounded" name="organization_name[]" id="organization_name" placeholder="संस्थाको नाम" value="">
                                    </td>
                                    <td class="col-md-1">
                                        <a class="js-sw-row-add btn btn-info btn-sm">
                                            <i class="fa fa-plus" title="add"></i>
