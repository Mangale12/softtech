                    ...
                    <div class="row">
                        <table class="table table-bordered" id="dynamicTable">
                            ...
                            <tr>
                                ...
                                <td style="width:30rem">
                                    <select name="addmore[0][damage_type_id]" class="form-control">
                                ...
                                <td style="width:20rem">
                                    <input type="nubmer" value="{{ old('quantity_damaged') }}" name="addmore[0][quantity_damaged]" placeholder="क्षतिको संख्या" class="form-control" />
                                ...
                                <td style="width:20rem">
                                    <input class="form-control rounded " type="text" id="date" value="{{getStandardNumber( $data['nep_date_unicode'])}}" name="addmore[0][damage_date]" placeholder="क्षतिको मिति" readonly>
