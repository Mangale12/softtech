...
<div class="inner-banner ">
    ...
    <img src="{{ asset($data['row']->thumbs)}}" alt="img">
    @endif
                ...
                <div class="main-content__details">
                    <div class="trail-details">
                        ...
                        <div class="page_content">
                            ...
                            @if(isset($data['row']->route_map) && file_exists(public_path($data['row']->route_map)))
                            <h2>
                                Route Map
                            </h2>
                            <div class="map mt-3">
                            ...
                            <div class="photo-video">
                                <div class="row g-2">
                                    ...
                                    @if(isset($row->image_path) && file_exists(public_path($row->image_path)))
                                    <div class="col-lg-4">
