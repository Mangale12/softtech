...
use App\Models\QuizPractice;
use Illuminate\Http\Request;

class QuizPracticeController extends DM_BaseController
{
    protected $panel = 'QuizPractice';
    protected $base_route = 'admin.quiz';
    protected $view_path = 'admin.quiz';
    protected $model;
    protected $table;

    public function __construct(QuizPractice $model)
    {
        $this->model = $model;
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($this->model->storeData($request, $request->question, $request->option_a, $request->option_b, $request->option_c, $request->option_d, $request->correct_answer, $request->rows)) {
