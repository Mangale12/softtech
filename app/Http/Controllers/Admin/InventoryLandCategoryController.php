...
class InventoryLandCategoryController extends DM_BaseController
{
    protected $panel = 'Land Setup';
    protected $base_route = 'admin.lnventory_land_category';
    protected $view_path = 'admin.lnventory_land_category';
    protected $model;
    protected $table;

    public function __construct(InventoryLandCategory $model)
    {
        $this->model = $model;
