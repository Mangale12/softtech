...
class InventoryFuelCategoryController extends DM_BaseController
{
    protected $panel = 'Feul Setup';
    protected $base_route = 'admin.lnventory_feul_category';
    protected $view_path = 'admin.lnventory_feul_category';
    protected $model;
    protected $table;

    public function __construct(InventoryFuelCategory $model)
    {
        $this->model = $model;
