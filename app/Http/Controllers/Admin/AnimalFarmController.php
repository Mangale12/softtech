...
class AnimalFarmController extends DM_BaseController
{
    protected $panel = 'Animal Farm';
    protected $base_route = 'admin.animal_farm';
    protected $view_path = 'admin.animal_farm';
    protected $model;
    protected $table;
    protected $folder = 'animal_farm';
    protected $image_prefix_path = '/upload_file/animal_farm/';
    ...
    public function __construct(AnimalFarm $model)
    {
        $this->model = $model;
    }
    ...
    public function create()
    {
        ...
        $data['animal-category']          = $this->model->getAnimalCategory();
