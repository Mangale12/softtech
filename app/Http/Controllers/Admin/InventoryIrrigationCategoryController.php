...
class InventoryIrrigationCategoryController extends DM_BaseController
{
    protected $panel = 'Irrigation Setup';
    protected $base_route = 'admin.lnventory_irrigation_category';
    protected $view_path = 'admin.lnventory_irrigation_category';
    protected $model;
    protected $table;

    public function __construct(InventoryIrrigationCategory $model)
    {
        $this->model = $model;
