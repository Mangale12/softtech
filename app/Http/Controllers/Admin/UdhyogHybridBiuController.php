...
{
    protected $panel = 'Udhyog Hybrid Biu';
    protected $base_route = 'admin.udhyog.hybridbiu.fianance';
    ...
    function fianance(){
        $data['vouchers'] = [];
        if (request()->is('admin/udhyog/hybridbiu/fianance/index')) {
    ...
    function fianance_create(){
        ...
        if (request()->is('admin/udhyog/hybridbiu/fianance/create')) {
            $data['udhyog'] = Udhyog::where('name', 'Hybrid Biu')->first();
            $data['path'] = 'दुध';
    ...
    function workersType(){
        try {
                $this->panel = 'Udhyog Hybrid Biu Workers Type';
                $workers_base_route = 'admin.udhyog.hybridbiu.workers';
                $this->base_route = 'admin.udhyog.hybridbiu.workers';
                $udhyog = Udhyog::where('name', 'Hybrid Biu')->first();
    ...
    function workersTypeCreate(){
        try{
                ...
                $this->panel = 'Udhyog Hybrid Biu Workers';
                $udhyog = Udhyog::where('name', 'Hybrid Biu')->first();
                $this->base_route = 'admin.udhyog.hybridbiu.workers.workerstype';
    ...
    function workersTypeStore(Request $request){
        ...
        return redirect()->route('admin.udhyog.hybridbiu.workers.workerstype.index')->with('success','Worker added successfully');
    }

    function workersPosition(){
        try {
                $this->panel = 'Udhyog Hybrid Biu Workers Position';
                $this->base_route = 'admin.udhyog.hybridbiu.workers';
                $udhyog = Udhyog::where('name', 'Hybrid Biu')->first();
    ...
    function workersPositionCreate(){
        try{
                ...
                $this->panel = 'Udhyog Hybrid Biu Workers';
                $udhyog = Udhyog::where('name', 'Hybrid Biu')->first();
                $this->base_route = 'admin.udhyog.hybridbiu.workers.workersposition';
    ...
    function workersPositionStore(Request $request){
        ...
        return redirect()->route('admin.udhyog.hybridbiu.workers.workersposition.index')->with('success','Worker added successfully');
    }

    function workersList(){
        try {
                // dd("test");
                $this->panel = 'Udhyog Hybrid Biu Workers List';
                $this->base_route = 'admin.udhyog.hybridbiu.workers';
                $udhyog = Udhyog::where('name', 'Hybrid Biu')->first();
    ...
    function workersListCreate(){
        try{
                ...
                $this->base_route = 'admin.udhyog.hybridbiu.workers.workerslist';
    ...
    function workersListStore(Request $request){
        ...
        return redirect()->route('admin.udhyog.hybridbiu.workers.workerslist.index');
    }
}
