...
class SiteController extends DM_BaseController
{
    ...
    {
        $data['banner'] = Banner::where('status', '=', 1)->where('deleted_at', '=', null)->orderBy('order', 'asc')->get();
        $data['product'] = Product::where('status', '=', 1)->where('deleted_at', '=', null)->orderBy('id', 'desc')->take(6)->get();
        $data['client'] = Clients::where('status', '=', 1)->where('deleted_at', '=', null)->orderBy('id', 'desc')->take(9)->get();
        $data['blog'] = Blog::where('status', '=', 1)->where('deleted_at', '=', null)->orderBy('id', 'desc')->take(6)->get();
